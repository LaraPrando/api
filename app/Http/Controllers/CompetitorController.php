...
class CompetitorController extends Controller
{
    ...
    {
        $validatedData = $request->validate(["name"=>"required|string|max:255", "age"=>"required|string|max:2", "height"=>"required|string|max:255", "weight"=>"required|string|max:255", "gender"=>"required|string|max:255", "cpf"=>"required|string|max:255", "rg"=>"required|string|max:255", "team"=>"required|string|max:255",]);
